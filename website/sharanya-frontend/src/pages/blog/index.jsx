      ...
      <div className={styles.mainContent}>
        ...
        <div className={styles.rightSidebar}>
          ...
          <div className={styles.tagsContainer}>
            {['Knee Pain', 'Physical Activity', 'Cervical Cancer', 'Pap Smear', 'Cancer Screening', 'Heart Disease', 'Preventative Cardiology', 'Skin Degloving', 'Injury Management', 'IDA Conference', 'Dental Conference', 'Golden Jubilee', 'ACPGCON 2023', 'Pulmonary Medicine', 'Shalby Con 2023', 'Critical Care Conference', 'Bone Sarcoma', 'Soft Tissue Sarcoma', 'Heatstroke', 'Heat Illness', 'Emergency Medicine', 'Surgery', 'Nutrition', 'Dietetics', 'Piles', 'Laser Treatment', 'Laparoscopic', 'Minimal Access Surgery', 'Medical Service', 'Events', 'Operation']
.map((tag, index) => (
