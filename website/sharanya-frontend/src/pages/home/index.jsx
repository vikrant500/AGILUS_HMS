...
const Home = () => {
  ...
  const specialities = [
    ...
    {
      title: "Homeopathy",
      link: "/treatment/homeopathy",
      image: assets.specialities.homeopathy,
      description:
      "Homeopathy uses diluted substances to stimulate the body's healing processes.<br> <a href= '/treatment/homeopathy' class='text-green-500'>Click here to know more.</a>",    },
    {
      title: "Diet",
      link: "/treatment/diet",
